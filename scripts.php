...
function cb_admin_scripts(){
	if(is_admin()){
		...
		wp_enqueue_script('cb_admin-js',plugins_url('inc/admin/js/cb_admin.js',__FILE__),array('jquery'));
		wp_enqueue_style('cb_admin-css',plugins_url('inc/admin/css/cb_admin.css',__FILE__),false, '1.0.0');
	}
}
function cb_front_scripts() {	
	if(!is_admin()){
		wp_enqueue_script('jquery');
		wp_enqueue_script('cb_front-js',plugins_url('inc/front/js/comparebar.js',__FILE__), array('jquery'));
		wp_enqueue_style('cb_front-css',plugins_url('inc/front/css/comparebar.css',__FILE__));
